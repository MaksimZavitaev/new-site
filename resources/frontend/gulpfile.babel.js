...
export const development = gulp.series(cleanFiles,
	gulp.parallel(views, styles, scripts, fonts, images, webpimages, favs),
	gulp.parallel(server));

export const prod = gulp.series(cleanFiles, serverConfig, views, styles, scripts, fonts, images, webpimages, favs);
